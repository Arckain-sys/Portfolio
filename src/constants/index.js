...
export const ABOUT_TEXT = `I am a dedicated and versatile frontend developer with a passion for creating efficient and user-friendly web applications. With 2 years of professional experience, I have worked with a variety of technologies, including React, React Native, Next.js, Node.js, MySQL, PostgreSQL, and MongoDB. My journey in web development began with a deep curiosity for how web and mobile apps are made, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments where different skills and perspectives are brought together. Outside of programming, I enjoy playing music, driving my motorcycle, and spending time with my friends and family. I am a native speaker of both English and Spanish languages`;
